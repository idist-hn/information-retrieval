...
### Oxford5K
```bash
mkdir -p data/oxford5k/images data/oxford5k/gt
...
# → giải nén vào data/oxford5k/images/ và data/oxford5k/gt/
```

### Paris6K
```bash
mkdir -p data/paris6k/images data/paris6k/gt
...
# → giải nén vào data/paris6k/images/ và data/paris6k/gt/
```

---

## 3. Đánh giá trên dataset
...
## 6. Thay đổi cấu hình thực nghiệm
